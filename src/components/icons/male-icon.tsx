...
export default function MaleIcon({ color, colorGradient }: Agent) {
  return (
    <svg
    ...
    >
      <linearGradient
        id="XUTUIGNJMUcugJDJhUDeUa_VQ4hRQLjAFt6_gr1"
        x1="24"
        x2="24"
        y1="52.156"
        y2="18.098"
      ...
      ></path>
      <linearGradient
        id="XUTUIGNJMUcugJDJhUDeUb_VQ4hRQLjAFt6_gr2"
        x1="24"
        x2="24"
        y1="27.38"
        y2="-.326"
        gradientUnits="userSpaceOnUse"
      >
        <stop offset="0" stopColor={colorGradient[4]} stopOpacity=".4"></stop>
        <stop offset="1" stopColor={colorGradient[3]} stopOpacity=".3"></stop>
      </linearGradient>
      <path
        fill="url(#XUTUIGNJMUcugJDJhUDeUb_VQ4hRQLjAFt6_gr2)"
      ...
      ></path>
      <linearGradient
        id="XUTUIGNJMUcugJDJhUDeUc_VQ4hRQLjAFt6_gr3"
        x1="24"
        x2="24"
        y1="22.015"
        y2="3.803"
        gradientUnits="userSpaceOnUse"
      >
        <stop offset="0" stopColor={colorGradient[2]} stopOpacity=".3"></stop>
        <stop offset="1" stopColor={colorGradient[2]} stopOpacity=".4"></stop>
      </linearGradient>
      <path
        fill="url(#XUTUIGNJMUcugJDJhUDeUc_VQ4hRQLjAFt6_gr3)"
